...
ParticleEngine.prototype.initialize = function()
{
	...
	//console.log("About to add particle mesh!");

	this.particleMesh.position.x = 0;
	this.particleMesh.position.y = 0;
	this.particleMesh.position.z = 0; 
	

	console.log("mesh positions: ")
	console.log(this.particleMesh.position);
	// console.log(this.particleMesh.position.x);
	// console.log(this.particleMesh.position.y);
	// console.log(this.particleMesh.position.z);

	this.particleMesh.scale.set(10,10,10);
